...
$result = $mysqli->query("SELECT * FROM hackathon_diseased WHERE login = '".$_POST['login']."' AND password = '".$_POST['password']."';");
...
if($result->num_rows > 0)
{
    ...
    if($row['token'] != "") {
        ...
        $mysqli->query("UPDATE hackathon_diseased SET token = '".$token."' WHERE id = ".$row['id'].";");
